 ...
 * chao.chen
 */
public final class PreciseTableShardingByDateRangeAlgorithm implements RangeShardingAlgorithm<Date> {


    Logger logger = LoggerFactory.getLogger(PreciseTableShardingByDateRangeAlgorithm.class);
